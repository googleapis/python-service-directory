...
from google.cloud.servicedirectory_v1.services.registration_service import RegistrationServiceAsyncClient
from google.cloud.servicedirectory_v1.services.registration_service import RegistrationServiceClient
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    (RegistrationServiceClient, transports.RegistrationServiceGrpcTransport, "grpc"),
    (RegistrationServiceAsyncClient, transports.RegistrationServiceGrpcAsyncIOTransport, "grpc_asyncio"),
    (RegistrationServiceClient, transports.RegistrationServiceRestTransport, "rest"),
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (RegistrationServiceClient, transports.RegistrationServiceGrpcTransport, "grpc", "true"),
    (RegistrationServiceAsyncClient, transports.RegistrationServiceGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (RegistrationServiceClient, transports.RegistrationServiceGrpcTransport, "grpc", "false"),
    (RegistrationServiceAsyncClient, transports.RegistrationServiceGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (RegistrationServiceClient, transports.RegistrationServiceRestTransport, "rest", "true"),
    (RegistrationServiceClient, transports.RegistrationServiceRestTransport, "rest", "false"),
])
@mock.patch.object(RegistrationServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(RegistrationServiceClient))
@mock.patch.object(RegistrationServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(RegistrationServiceAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    RegistrationServiceClient, RegistrationServiceAsyncClient
])
@mock.patch.object(RegistrationServiceClient, "DEFAULT_ENDPOINT", modify_default_endpoint(RegistrationServiceClient))
@mock.patch.object(RegistrationServiceAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(RegistrationServiceAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (RegistrationServiceClient, transports.RegistrationServiceGrpcTransport, "grpc", grpc_helpers),
    (RegistrationServiceAsyncClient, transports.RegistrationServiceGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (RegistrationServiceClient, transports.RegistrationServiceRestTransport, "rest", None),
])
...
def test_registration_service_client_client_options_from_dict():
    with mock.patch('google.cloud.servicedirectory_v1.services.registration_service.transports.RegistrationServiceGrpcTransport.__init__') as grpc_transport:
...
async def test_list_namespaces_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_namespaces(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_create_namespace_rest_interceptors(null_interceptor):
    transport = transports.RegistrationServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.RegistrationServiceRestInterceptor(),
        )
    client = RegistrationServiceClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_create_namespace") as post, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_create_namespace") as pre:
...
def test_create_namespace_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*}/namespaces" % client.transport._host, args[1])
...
def test_list_namespaces_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = registration_service.ListNamespacesResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_namespaces_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_list_namespaces") as post, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_list_namespaces") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_namespace_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_get_namespace") as post, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_get_namespace") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_namespace_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/namespaces/*}" % client.transport._host, args[1])
...
def test_update_namespace_rest(request_type):
    ...
    request_init["namespace"] = {'name': 'projects/sample1/locations/sample2/namespaces/sample3', 'labels': {}}
    request = request_type(**request_init)
...
def test_update_namespace_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_update_namespace") as post, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_update_namespace") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_namespace_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{namespace.name=projects/*/locations/*/namespaces/*}" % client.transport._host, args[1])
...
def test_delete_namespace_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_delete_namespace") as pre:
        pre.assert_not_called()
...
def test_create_service_rest(request_type):
    ...
    request_init["service"] = {'name': 'name_value', 'annotations': {}, 'endpoints': [{'name': 'name_value', 'address': 'address_value', 'port': 453, 'annotations': {}}]}
    request = request_type(**request_init)
...
def test_create_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_create_service") as post, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_create_service") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/namespaces/*}/services" % client.transport._host, args[1])
...
def test_list_services_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = registration_service.ListServicesResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_services_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_list_services") as post, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_list_services") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_get_service") as post, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_get_service") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/namespaces/*/services/*}" % client.transport._host, args[1])
...
def test_update_service_rest(request_type):
    ...
    request_init["service"] = {'name': 'projects/sample1/locations/sample2/namespaces/sample3/services/sample4', 'annotations': {}, 'endpoints': [{'name': 'name_value', 'address': 'address_value', 'port': 453, 'annotations': {}}]}
    request = request_type(**request_init)
...
def test_update_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_update_service") as post, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_update_service") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_service_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{service.name=projects/*/locations/*/namespaces/*/services/*}" % client.transport._host, args[1])
...
def test_delete_service_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_delete_service") as pre:
        pre.assert_not_called()
...
def test_create_endpoint_rest(request_type):
    ...
    request_init["endpoint"] = {'name': 'name_value', 'address': 'address_value', 'port': 453, 'annotations': {}}
    request = request_type(**request_init)
...
def test_create_endpoint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_create_endpoint") as post, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_create_endpoint") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_endpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{parent=projects/*/locations/*/namespaces/*/services/*}/endpoints" % client.transport._host, args[1])
...
def test_list_endpoints_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = registration_service.ListEndpointsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_endpoints_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_list_endpoints") as post, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_list_endpoints") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_endpoint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_get_endpoint") as post, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_get_endpoint") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_endpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{name=projects/*/locations/*/namespaces/*/services/*/endpoints/*}" % client.transport._host, args[1])
...
def test_update_endpoint_rest(request_type):
    ...
    request_init["endpoint"] = {'name': 'projects/sample1/locations/sample2/namespaces/sample3/services/sample4/endpoints/sample5', 'address': 'address_value', 'port': 453, 'annotations': {}}
    request = request_type(**request_init)
...
def test_update_endpoint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_update_endpoint") as post, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_update_endpoint") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_endpoint_rest_flattened():
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        assert len(req.mock_calls) == 1
        _, args, _ = req.mock_calls[0]
        assert path_template.validate("%s/v1/{endpoint.name=projects/*/locations/*/namespaces/*/services/*/endpoints/*}" % client.transport._host, args[1])
...
def test_delete_endpoint_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_delete_endpoint") as pre:
        pre.assert_not_called()
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_get_iam_policy") as post, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_set_iam_policy") as post, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "post_test_iam_permissions") as post, \
         mock.patch.object(transports.RegistrationServiceRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_registration_service_base_transport():
    ...
    with mock.patch('google.cloud.servicedirectory_v1.services.registration_service.transports.RegistrationServiceTransport.__init__') as Transport:
...
def test_registration_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.servicedirectory_v1.services.registration_service.transports.RegistrationServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_registration_service_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.servicedirectory_v1.services.registration_service.transports.RegistrationServiceTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.RegistrationServiceTransport()
        adc.assert_called_once()
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.RegistrationServiceGrpcTransport, transports.RegistrationServiceGrpcAsyncIOTransport])
def test_registration_service_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (RegistrationServiceAsyncClient, transports.RegistrationServiceGrpcAsyncIOTransport),
])
